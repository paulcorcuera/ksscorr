...
{synopt : {opth partial:out({opt controlvars})}}covariates to be partialled-out before performing two-way FE correction({p_end}
...
{p2colset 8 12 12 2}{...}
{p2col: -}Implement the postestimation inference (lincom){p_end}
{p2colreset}{...}
...
{hline}
{pstd}Setup{p_end}
{phang2}{cmd:. use employeremployeedata}{p_end}
