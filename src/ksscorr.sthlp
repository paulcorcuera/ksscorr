...
In particular, suppose you are running a high dimensional linear model {hilite: y = X b + e }, where {hi: b} contains fixed effects in two large dimensions (e.g. worker and firms). Any quadratic form of {hi:b} is biased (see {browse "https://github.com/rsaggio87/LeaveOutTwoWay/blob/master/doc/VIGNETTE.pdf":here} for more information). 
